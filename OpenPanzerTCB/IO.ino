...
{   // For safety, we only do anything if this has been set to output
    ...
    { 
        ...
        if (DEBUG) { DebugSerial->println(F("IO Port A On")); }
    }
}
void PortA_Off()
{   // For safety, we only do anything if this has been set to output
    ...
    { 
        ...
        if (DEBUG) { DebugSerial->println(F("IO Port A Off")); }
    }
}
void PortA_Toggle()
{
...
{   // For safety, we only do anything if this has been set to output
    ...
    { 
        ...
        if (DEBUG) { DebugSerial->println(F("IO Port B On")); }
    }
}
void PortB_Off()
{   // For safety, we only do anything if this has been set to output
    ...
    { 
        ...
        if (DEBUG) { DebugSerial->println(F("IO Port B Off")); }
    }
}
void PortB_Toggle()
{
