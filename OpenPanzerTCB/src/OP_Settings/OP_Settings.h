...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.93.07"      // version. Last update 7/1/2018
    
    #define MIN_OPCONFIG_VERSION    "0.93.07"      // Minimum version of OP Config this version of firmware requires
