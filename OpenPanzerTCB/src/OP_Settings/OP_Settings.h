...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.94.04"	   // version. Last update 2/3/2026
    
    #define MIN_OPCONFIG_VERSION    "0.94.04"      // Minimum version of OP Config this version of firmware requires
