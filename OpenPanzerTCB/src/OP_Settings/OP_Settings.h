...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.93.02"      // version. Last update 4/10/2018
    
    #define MIN_OPCONFIG_VERSION    "0.93.01"      // Minimum version of OP Config this version of firmware requires
