...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.92.21"      // version. Last update 2/4/2018
    
    #define MIN_OPCONFIG_VERSION    "0.92.21"      // Minimum version of OP Config this version of firmware requires
