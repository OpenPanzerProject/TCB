...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.93.52"      // version. Last update 8/20/2019
    
    #define MIN_OPCONFIG_VERSION    "0.93.51"      // Minimum version of OP Config this version of firmware requires
