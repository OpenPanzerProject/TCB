...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.92.08"      // version. Last update 07/24/2017
    
    #define MIN_OPCONFIG_VERSION    "0.92.07"      // Minimum version of OP Config this version of firmware requires
