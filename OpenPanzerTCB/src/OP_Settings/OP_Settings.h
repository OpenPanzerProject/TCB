...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.92.07"      // version. Last update 07/18/2017
    
    #define MIN_OPCONFIG_VERSION    "0.92.06"      // Minimum version of OP Config this version of firmware requires
