...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.92.01"      // version. Last update 02/26/2017
    
    #define MIN_OPCONFIG_VERSION    "0.92.01"      // Minimum version of OP Config this version of firmware requires
