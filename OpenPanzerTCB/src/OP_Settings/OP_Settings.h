...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.92.06"      // version. Last update 07/14/2017
    
    #define MIN_OPCONFIG_VERSION    "0.92.05"      // Minimum version of OP Config this version of firmware requires
