...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.93.50"      // version. Last update 5/12/2019
    
    #define MIN_OPCONFIG_VERSION    "0.93.49"      // Minimum version of OP Config this version of firmware requires
