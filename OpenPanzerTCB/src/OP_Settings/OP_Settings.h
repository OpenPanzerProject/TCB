...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.93.06"      // version. Last update 6/30/2018
    
    #define MIN_OPCONFIG_VERSION    "0.93.06"      // Minimum version of OP Config this version of firmware requires
