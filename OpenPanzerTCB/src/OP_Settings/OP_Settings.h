...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.92.04"      // version. Last update 04/17/2017
    
    #define MIN_OPCONFIG_VERSION    "0.92.03"      // Minimum version of OP Config this version of firmware requires
