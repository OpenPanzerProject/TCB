...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.92.02"      // version. Last update 03/03/2017
    
    #define MIN_OPCONFIG_VERSION    "0.92.02"      // Minimum version of OP Config this version of firmware requires
