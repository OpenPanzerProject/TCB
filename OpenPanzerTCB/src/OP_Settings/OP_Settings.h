...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.91.02"      // version. Last update 02/12/2017
    
    #define MIN_OPCONFIG_VERSION    "0.91.02"      // Minimum version of OP Config this version of firmware requires
