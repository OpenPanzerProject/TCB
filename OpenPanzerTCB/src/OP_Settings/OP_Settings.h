...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.93.05"      // version. Last update 5/1/2018
    
    #define MIN_OPCONFIG_VERSION    "0.93.05"      // Minimum version of OP Config this version of firmware requires
