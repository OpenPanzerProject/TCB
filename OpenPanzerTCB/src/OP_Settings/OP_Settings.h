...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.93.62"      // version. Last update 9/22/2019
    
    #define MIN_OPCONFIG_VERSION    "0.93.60"      // Minimum version of OP Config this version of firmware requires
