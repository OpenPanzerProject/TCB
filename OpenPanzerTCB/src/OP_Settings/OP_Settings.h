...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.92.20"      // version. Last update 1/27/2018
    
    #define MIN_OPCONFIG_VERSION    "0.92.20"      // Minimum version of OP Config this version of firmware requires
