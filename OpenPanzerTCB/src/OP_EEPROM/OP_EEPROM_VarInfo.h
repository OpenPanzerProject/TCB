...
const _storage_var_info STORAGEVARS[NUM_STORED_VARS] PROGMEM_FAR = {     
    ...
    {2211, 319, varBOOL},        // SmokerControlAuto
    {2212, 320, varINT16},        // SmokerIdleSpeed
    {2213, 322, varINT16},        // SmokerFastIdleSpeed
    {2214, 324, varINT16},        // SmokerMaxSpeed
    {2215, 326, varINT16},        // SmokerDestroyedSpeed
    {2411, 328, varBOOL},        // AccelRampEnabled_1
    {2412, 329, varUINT8},        // AccelSkipNum_1
    {2413, 330, varUINT8},        // AccelPreset_1
    {2414, 331, varBOOL},        // DecelRampEnabled_1
    {2415, 332, varUINT8},        // DecelSkipNum_1
    {2416, 333, varUINT8},        // DecelPreset_1
    {2417, 334, varBOOL},        // AccelRampEnabled_2
    {2418, 335, varUINT8},        // AccelSkipNum_2
    {2419, 336, varUINT8},        // AccelPreset_2
    {2420, 337, varBOOL},        // DecelRampEnabled_2
    {2421, 338, varUINT8},        // DecelSkipNum_2
    {2422, 339, varUINT8},        // DecelPreset_2
    {2423, 340, varUINT8},        // BrakeSensitivityPct
    {2424, 341, varUINT16},        // TimeToShift_mS
    {2425, 343, varUINT16},        // EnginePauseTime_mS
    {2426, 345, varUINT16},        // TransmissionDelay_mS
    {2427, 347, varBOOL},        // NeutralTurnAllowed
    {2428, 348, varUINT8},        // NeutralTurnPct
    {2429, 349, varUINT8},        // TurnMode
    {2430, 350, varUINT8},        // DriveType
    {2431, 351, varUINT8},        // MaxForwardSpeedPct
    {2432, 352, varUINT8},        // MaxReverseSpeedPct
    {2433, 353, varUINT8},        // HalftrackTreadTurnPct
    {2434, 354, varBOOL},        // EngineAutoStart
    {2435, 355, varINT32},        // EngineAutoStopTime_mS
    {2436, 359, varUINT8},        // MotorNudgePct
    {2437, 360, varUINT16},        // NudgeTime_mS
    {2438, 362, varBOOL},        // DragInnerTrack
    {2439, 363, varBOOL},        // EnableTrackRecoil
    {2440, 364, varUINT8},        // TrackRecoilKickbackSpeed
    {2441, 365, varUINT8},        // TrackRecoilDecelerateFactor
    {2511, 366, varBOOL},        // EnableBarrelStabilize
    {2512, 367, varUINT8},        // BarrelSensitivity
    {2513, 368, varBOOL},        // EnableHillPhysics
    {2514, 369, varUINT8},        // HillSensitivity
    {2711, 370, varINT16},        // IgnoreTurretDelay_mS
    {2811, 372, varUINT8},        // SoundDevice
    {2812, 373, varUINT16},        // Squeak1_MinInterval_mS
    {2813, 375, varUINT16},        // Squeak1_MaxInterval_mS
    {2814, 377, varUINT16},        // Squeak2_MinInterval_mS
    {2815, 379, varUINT16},        // Squeak2_MaxInterval_mS
    {2816, 381, varUINT16},        // Squeak3_MinInterval_mS
    {2817, 383, varUINT16},        // Squeak3_MaxInterval_mS
    {2818, 385, varBOOL},        // Squeak1_Enabled
    {2819, 386, varBOOL},        // Squeak2_Enabled
    {2820, 387, varBOOL},        // Squeak3_Enabled
    {2821, 388, varUINT8},        // MinSqueakSpeed
    {2822, 389, varBOOL},        // HeadlightSound_Enabled
    {2823, 390, varBOOL},        // TurretSound_Enabled
    {2824, 391, varBOOL},        // BarrelSound_Enabled
    {2825, 392, varUINT16},        // Squeak4_MinInterval_mS
    {2826, 394, varUINT16},        // Squeak4_MaxInterval_mS
    {2827, 396, varUINT16},        // Squeak5_MinInterval_mS
    {2828, 398, varUINT16},        // Squeak5_MaxInterval_mS
    {2829, 400, varUINT16},        // Squeak6_MinInterval_mS
    {2830, 402, varUINT16},        // Squeak6_MaxInterval_mS
    {2831, 404, varBOOL},        // Squeak4_Enabled
    {2832, 405, varBOOL},        // Squeak5_Enabled
    {2833, 406, varBOOL},        // Squeak6_Enabled
    {2834, 407, varUINT8},        // VolumeEngine
    {2835, 408, varUINT8},        // VolumeTrackOverlay
    {2836, 409, varUINT8},        // VolumeEffects
    {2837, 410, varBOOL},        // HeadlightSound2_Enabled
    {2838, 411, varBOOL},        // SoundBankA_Loop
    {2839, 412, varBOOL},        // SoundBankB_Loop
    {3011, 413, varUINT8},        // IR_FireProtocol
    {3012, 414, varUINT8},        // IR_HitProtocol_2
    {3013, 415, varUINT8},        // IR_RepairProtocol
    {3014, 416, varUINT8},        // IR_MGProtocol
    {3015, 417, varBOOL},        // Use_MG_Protocol
    {3016, 418, varBOOL},        // Accept_MG_Damage
    {3017, 419, varUINT8},        // DamageProfile
    {3018, 420, varUINT16},        // CustomClassSettings.reloadTime
    {3019, 422, varUINT16},        // CustomClassSettings.recoveryTime
    {3020, 424, varUINT8},        // CustomClassSettings.maxHits
    {3021, 425, varUINT8},        // CustomClassSettings.maxMGHits
    {3022, 426, varBOOL},        // SendTankID
    {3023, 427, varUINT16},        // TankID
    {3024, 429, varUINT8},        // IR_Team
    {3211, 430, varUINT32},        // USBSerialBaud
    {3212, 434, varUINT32},        // AuxSerialBaud
    {3213, 438, varUINT32},        // MotorSerialBaud
    {3214, 442, varUINT32},        // Serial3TxBaud
    {3215, 446, varBOOL},        // LVC_Enabled
    {3216, 447, varUINT16},        // LVC_Cutoff_mV
    {3411, 449, varBOOL},        // RunningLightsAlwaysOn
    {3412, 450, varUINT8},        // RunningLightsDimLevelPct
    {3413, 451, varBOOL},        // BrakesAutoOnAtStop
    {3414, 452, varUINT16},        // AuxLightFlashTime_mS
    {3415, 454, varUINT16},        // AuxLightBlinkOnTime_mS
    {3416, 456, varUINT16},        // AuxLightBlinkOffTime_mS
    {3417, 458, varUINT8},        // AuxLightPresetDim
    {3418, 459, varUINT8},        // MGLightBlink_mS
    {3419, 460, varBOOL},        // FlashLightsWhenSignalLost
    {3420, 461, varBOOL},        // HiFlashWithCannon
    {3421, 462, varBOOL},        // AuxFlashWithCannon
    {3422, 463, varUINT8},        // SecondMGLightBlink_mS
    {3423, 464, varBOOL},        // CannonReloadBlink
    {3611, 465, varUINT8},        // ScoutCurrentLimit
    {9011, 466, varBOOL},        // PrintDebug
    {9999, 467, varUINT32}        // InitStamp
};
