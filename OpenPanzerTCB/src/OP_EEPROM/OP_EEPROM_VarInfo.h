...
const _storage_var_info STORAGEVARS[NUM_STORED_VARS] PROGMEM_FAR = {     
    ...
    {2411, 337, varBOOL},        // AccelRampEnabled_1
    {2412, 338, varUINT8},        // AccelSkipNum_1
    {2413, 339, varUINT8},        // AccelPreset_1
    {2414, 340, varBOOL},        // DecelRampEnabled_1
    {2415, 341, varUINT8},        // DecelSkipNum_1
    {2416, 342, varUINT8},        // DecelPreset_1
    {2417, 343, varBOOL},        // AccelRampEnabled_2
    {2418, 344, varUINT8},        // AccelSkipNum_2
    {2419, 345, varUINT8},        // AccelPreset_2
    {2420, 346, varBOOL},        // DecelRampEnabled_2
    {2421, 347, varUINT8},        // DecelSkipNum_2
    {2422, 348, varUINT8},        // DecelPreset_2
    {2423, 349, varUINT8},        // BrakeSensitivityPct
    {2424, 350, varUINT16},        // TimeToShift_mS
    {2425, 352, varUINT16},        // EnginePauseTime_mS
    {2426, 354, varUINT16},        // TransmissionDelay_mS
    {2427, 356, varBOOL},        // NeutralTurnAllowed
    {2428, 357, varUINT8},        // NeutralTurnPct
    {2429, 358, varUINT8},        // TurnMode
    {2430, 359, varUINT8},        // DriveType
    {2431, 360, varUINT8},        // MaxForwardSpeedPct
    {2432, 361, varUINT8},        // MaxReverseSpeedPct
    {2433, 362, varUINT8},        // HalftrackTreadTurnPct
    {2434, 363, varBOOL},        // EngineAutoStart
    {2435, 364, varINT32},        // EngineAutoStopTime_mS
    {2436, 368, varUINT8},        // MotorNudgePct
    {2437, 369, varUINT16},        // NudgeTime_mS
    {2438, 371, varBOOL},        // DragInnerTrack
    {2439, 372, varBOOL},        // EnableTrackRecoil
    {2440, 373, varUINT8},        // TrackRecoilKickbackSpeed
    {2441, 374, varUINT8},        // TrackRecoilDecelerateFactor
    {2511, 375, varBOOL},        // EnableBarrelStabilize
    {2512, 376, varUINT8},        // BarrelSensitivity
    {2513, 377, varBOOL},        // EnableHillPhysics
    {2514, 378, varUINT8},        // HillSensitivity
    {2711, 379, varINT16},        // IgnoreTurretDelay_mS
    {2811, 381, varUINT8},        // SoundDevice
    {2812, 382, varUINT16},        // Squeak1_MinInterval_mS
    {2813, 384, varUINT16},        // Squeak1_MaxInterval_mS
    {2814, 386, varUINT16},        // Squeak2_MinInterval_mS
    {2815, 388, varUINT16},        // Squeak2_MaxInterval_mS
    {2816, 390, varUINT16},        // Squeak3_MinInterval_mS
    {2817, 392, varUINT16},        // Squeak3_MaxInterval_mS
    {2818, 394, varBOOL},        // Squeak1_Enabled
    {2819, 395, varBOOL},        // Squeak2_Enabled
    {2820, 396, varBOOL},        // Squeak3_Enabled
    {2821, 397, varUINT8},        // MinSqueakSpeed
    {2822, 398, varBOOL},        // HeadlightSound_Enabled
    {2823, 399, varBOOL},        // TurretSound_Enabled
    {2824, 400, varBOOL},        // BarrelSound_Enabled
    {2825, 401, varUINT16},        // Squeak4_MinInterval_mS
    {2826, 403, varUINT16},        // Squeak4_MaxInterval_mS
    {2827, 405, varUINT16},        // Squeak5_MinInterval_mS
    {2828, 407, varUINT16},        // Squeak5_MaxInterval_mS
    {2829, 409, varUINT16},        // Squeak6_MinInterval_mS
    {2830, 411, varUINT16},        // Squeak6_MaxInterval_mS
    {2831, 413, varBOOL},        // Squeak4_Enabled
    {2832, 414, varBOOL},        // Squeak5_Enabled
    {2833, 415, varBOOL},        // Squeak6_Enabled
    {2834, 416, varUINT8},        // VolumeEngine
    {2835, 417, varUINT8},        // VolumeTrackOverlay
    {2836, 418, varUINT8},        // VolumeEffects
    {2837, 419, varBOOL},        // HeadlightSound2_Enabled
    {2838, 420, varBOOL},        // SoundBankA_Loop
    {2839, 421, varBOOL},        // SoundBankB_Loop
    {3011, 422, varUINT8},        // IR_FireProtocol
    {3012, 423, varUINT8},        // IR_HitProtocol_2
    {3013, 424, varUINT8},        // IR_RepairProtocol
    {3014, 425, varUINT8},        // IR_MGProtocol
    {3015, 426, varBOOL},        // Use_MG_Protocol
    {3016, 427, varBOOL},        // Accept_MG_Damage
    {3017, 428, varUINT8},        // DamageProfile
    {3018, 429, varUINT16},        // CustomClassSettings.reloadTime
    {3019, 431, varUINT16},        // CustomClassSettings.recoveryTime
    {3020, 433, varUINT8},        // CustomClassSettings.maxHits
    {3021, 434, varUINT8},        // CustomClassSettings.maxMGHits
    {3022, 435, varBOOL},        // SendTankID
    {3023, 436, varUINT16},        // TankID
    {3024, 438, varUINT8},        // IR_Team
    {3211, 439, varUINT32},        // USBSerialBaud
    {3212, 443, varUINT32},        // AuxSerialBaud
    {3213, 447, varUINT32},        // MotorSerialBaud
    {3214, 451, varUINT32},        // Serial3TxBaud
    {3215, 455, varBOOL},        // LVC_Enabled
    {3216, 456, varUINT16},        // LVC_Cutoff_mV
    {3411, 458, varBOOL},        // RunningLightsAlwaysOn
    {3412, 459, varUINT8},        // RunningLightsDimLevelPct
    {3413, 460, varBOOL},        // BrakesAutoOnAtStop
    {3414, 461, varUINT16},        // AuxLightFlashTime_mS
    {3415, 463, varUINT16},        // AuxLightBlinkOnTime_mS
    {3416, 465, varUINT16},        // AuxLightBlinkOffTime_mS
    {3417, 467, varUINT8},        // AuxLightPresetDim
    {3418, 468, varUINT8},        // MGLightBlink_mS
    {3419, 469, varBOOL},        // FlashLightsWhenSignalLost
    {3420, 470, varBOOL},        // HiFlashWithCannon
    {3421, 471, varBOOL},        // AuxFlashWithCannon
    {3422, 472, varUINT8},        // SecondMGLightBlink_mS
    {3423, 473, varBOOL},        // CannonReloadBlink
    {3611, 474, varUINT8},        // ScoutCurrentLimit
    {9011, 475, varBOOL},        // PrintDebug
    {9999, 476, varUINT32}        // InitStamp
};
