...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.91.01"      // version. Last update 02/07/2017
    
    #define MIN_OPCONFIG_VERSION    "0.91.01"      // Minimum version of OP Config this version of firmware requires
