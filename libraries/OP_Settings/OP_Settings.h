...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.91.00"      // version. Last update 02/04/2017
    
    #define MIN_OPCONFIG_VERSION    "0.91.00"      // Minimum version of OP Config this version of firmware requires
